...
if __name__ == '__main__':
    ...
    parser.add_argument('--data-dir', type=str, metavar='PATH',
                        default='/home/txd/data/Cross-Modal ReID data')
    parser.add_argument('--logs-dir', type=str, metavar='PATH',
                        default=osp.join(working_dir, 'MM01/Exp6(384*192)'))
    # hyper-parameters
    ...
    # device set
    parser.add_argument('--visible_device', default='0,2,3,4,5', type=str, help='gpu_ids: e.g. 0, 0,1,2  0,2')
