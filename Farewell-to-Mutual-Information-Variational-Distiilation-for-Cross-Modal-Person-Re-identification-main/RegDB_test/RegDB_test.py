...
import sys
sys.path.append('/home/txd/Farewell-to-Mutual-Information-Variational-Distiilation-for-Cross-Modal-Person-Re-identification-main/')
...
parser.add_argument('--height', type=int, default=384, help='image height, should be chosen in {256, 288, 312}')
parser.add_argument('--width', type=int, default=192, help='image width, should be chosen in {128, 144, 156}')

parser.add_argument('--model_path', default='/home/txd/Farewell-to-Mutual-Information-Variational-Distiilation-for-Cross-Modal-Person-Re-identification-main/RegDB/Exp3(384*192)/', type=str)
parser.add_argument('--data_path', type=str, default='/home/txd/data/Cross-Modal ReID data/RegDB/',
                    help='RegDB data path, may vary on different servers')
