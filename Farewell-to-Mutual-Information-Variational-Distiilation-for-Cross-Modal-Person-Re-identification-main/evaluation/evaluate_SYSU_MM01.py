...
#sys.path.append('/home/host/Variational Distillation')
...
def evaluate(feature_dir, prefix, settings, total_runs=10):
    ...
    for cam_index in all_cams:
        # read features
        cam_feature_file = osp.join(feature_dir, prefix+("{}").format(cam_index))
...
if __name__ == "__main__":
    ...
    feature_dir = "/home/txd/Farewell-to-Mutual-Information-Variational-Distiilation-for-Cross-Modal-Person-Re-identification-main/MM01/Exp2(num_instance=8)"
    prefix = "observationcam"
