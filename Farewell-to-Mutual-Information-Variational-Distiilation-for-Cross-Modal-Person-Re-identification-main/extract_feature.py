...
features = 512 # 8192 for observation (four in total), 2048 for representation (four in total)
os.environ["CUDA_VISIBLE_DEVICES"] = "1"
model = ft_net(args=args, num_classes=395, num_features=args.features)
model_path = "/home/txd/Farewell-to-Mutual-Information-Variational-Distiilation-for-Cross-Modal-Person-Re-identification-main/" \
			 "MM01/Exp3(num_instance=8,batch=128)/"
...
path_list = ['/home/txd/data/Cross-Modal ReID data/sysu/SYSU-MM01/cam1/',
			 '/home/txd/data/Cross-Modal ReID data/sysu/SYSU-MM01/cam2/',
			 '/home/txd/data/Cross-Modal ReID data/sysu/SYSU-MM01/cam3/',
             '/home/txd/data/Cross-Modal ReID data/sysu/SYSU-MM01/cam4/',
			 '/home/txd/data/Cross-Modal ReID data/sysu/SYSU-MM01/cam5/',
			 '/home/txd/data/Cross-Modal ReID data/sysu/SYSU-MM01/cam6/']
...
for index, path in enumerate(path_list):
	...
	for person in person_id_list:
		...
		for imagename in dict_person[person]:
			...
			result_y = torch.cat(tensors=[v_ms_representation[1]], dim=1)
	...
	sio.savemat(model_path + "v_ms_representation_" + cam_name + '.mat', {'feature_test':array_list_to_array})
