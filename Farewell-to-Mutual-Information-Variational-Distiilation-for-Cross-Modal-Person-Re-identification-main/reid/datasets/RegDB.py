...
class RegDB(Dataset):
    ...
    def download(self):
        index_train_RGB = open('/home/txd/data/Cross-Modal ReID data/RegDB/idx/train_visible_{}.txt'.format(self.ii),'r')
        index_train_IR = open('/home/txd/data/Cross-Modal ReID data/RegDB/idx/train_thermal_{}.txt'.format(self.ii),'r')
        index_test_RGB = open('/home/txd/data/Cross-Modal ReID data/RegDB/idx/test_visible_{}.txt'.format(self.ii),'r')
        index_test_IR = open('/home/txd/data/Cross-Modal ReID data/RegDB/idx/test_thermal_{}.txt'.format(self.ii),'r')
